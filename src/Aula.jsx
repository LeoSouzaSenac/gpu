...
2026/07/10 21:17:51.123, 0 %, 0 MiB, 51`}
      ...
      <Section>
        ...
        <H2>Bora jogar? — GPU Game</H2>
        <P>
          Montamos 5 minigames curtos pra praticar exatamente o que foi visto hoje: o gargalo de Von Neumann, montar uma CPU, decidir CPU x GPU tarefa por tarefa, ler um painel de nvidia-smi como um detetive, e o glossário todo, contra o relógio.
        </P>
        <a href="#jogo" style={{ textDecoration: "none" }}>
          <div style={{
            ...
            Jogar GPU Game <ArrowRight size={16} />
          </div>
        </a>
      </Section>
